...
inline void HYP_Helper_2(double *gauge_field, int T, int L, double time_link_alpha2, double *U, int it, int ix, int iy, int iz,
		int mu, int nu) {
	int rho;
...
inline void HYP_Helper_1(double *gauge_field, double *smeared_gauge_field, int T, int L, double time_link_alpha1, int it, int ix,
		int iy, int iz) {
	int index = ggi(get_index(it, ix, iy, iz, T, L), 0);
	double M1[18], M2[18], *SU3_1, *SU3_2, *SU3_3;
...
void HYP_Time_Links(double *gauge_field, double *smeared_gauge_field, int T, int L, double time_link_alpha1,
		...
		for (ix = 0; ix < L; ix++) {
			for (iy = 0; iy < L; iy++) {
				for (iz = 0; iz < L; iz++) {
					...
					HYP_Helper_3(gauge_field, T, L, time_link_alpha3, V3_0_1 + index, it, ix, iy, iz, 0, 2, 3);
					HYP_Helper_3(gauge_field, T, L, time_link_alpha3, V3_0_2 + index, it, ix, iy, iz, 0, 1, 3);
					HYP_Helper_3(gauge_field, T, L, time_link_alpha3, V3_0_3 + index, it, ix, iy, iz, 0, 1, 2);

					HYP_Helper_3(gauge_field, T, L, time_link_alpha3, V3_1_2 + index, it, ix, iy, iz, 1, 0, 3);
					HYP_Helper_3(gauge_field, T, L, time_link_alpha3, V3_1_3 + index, it, ix, iy, iz, 1, 0, 2);

					HYP_Helper_3(gauge_field, T, L, time_link_alpha3, V3_2_1 + index, it, ix, iy, iz, 2, 0, 3);
					HYP_Helper_3(gauge_field, T, L, time_link_alpha3, V3_2_3 + index, it, ix, iy, iz, 2, 0, 1);

					HYP_Helper_3(gauge_field, T, L, time_link_alpha3, V3_3_1 + index, it, ix, iy, iz, 3, 0, 2);
					HYP_Helper_3(gauge_field, T, L, time_link_alpha3, V3_3_2 + index, it, ix, iy, iz, 3, 0, 1);
				}
			}
		}
	}
		...
		for (ix = 0; ix < L; ix++) {
			for (iy = 0; iy < L; iy++) {
				for (iz = 0; iz < L; iz++) {
					...
					HYP_Helper_2(gauge_field, T, L, time_link_alpha2, V2_0_12 + index, it, ix, iy, iz, 0, 3);
					HYP_Helper_2(gauge_field, T, L, time_link_alpha2, V2_0_13 + index, it, ix, iy, iz, 0, 2);
					HYP_Helper_2(gauge_field, T, L, time_link_alpha2, V2_0_23 + index, it, ix, iy, iz, 0, 1);
					HYP_Helper_2(gauge_field, T, L, time_link_alpha2, V2_1_23 + index, it, ix, iy, iz, 1, 0);
					HYP_Helper_2(gauge_field, T, L, time_link_alpha2, V2_2_13 + index, it, ix, iy, iz, 2, 0);
					HYP_Helper_2(gauge_field, T, L, time_link_alpha2, V2_3_12 + index, it, ix, iy, iz, 3, 0);
				}
			}
		}
	}
	...
	for (it = 0; it < T; it++) {
		...
		for (ix = 0; ix < L; ix++) {
			for (iy = 0; iy < L; iy++) {
				for (iz = 0; iz < L; iz++) {
					HYP_Helper_1(gauge_field, smeared_gauge_field, T, L, time_link_alpha1, it, ix, iy, iz);
				}
			}
		}
	}
...
void APE_Smearing_Step_Timeslice(double *smeared_gauge_field, int T, int L, double APE_smearing_alpha, int timeslice) {
	...
	Gauge_Field_Copy_Timeslice(smeared_gauge_field_old, smeared_gauge_field, T, L, timeslice);
